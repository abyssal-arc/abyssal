  ...
  function apiIndex() {
    return {
      ...
      endpoints: {
        ...
        'POST /intervene': 'intervention (feed/poison/bloom/drought/name/wish/mutate/ark) paid by burning ABYS on Arc; the burn receipt is the payment proof; 503 until ABYS_TOKEN_ADDRESS is set',
